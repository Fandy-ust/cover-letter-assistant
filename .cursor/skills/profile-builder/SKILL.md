...
description: Builds and updates the user's personal profile from raw CV or career materials. Use when the user uploads a CV, LinkedIn export, or any background document to raw_inputs/profile/ and wants to update profile/personal_profile.md. Also use when the user wants to add a new experience, skill, or education entry to their profile.
---

# Profile Builder

## Project context
- Profile lives at `profile/personal_profile.md`
- Raw materials (CVs, exports) are in `raw_inputs/profile/` (supported formats: pdf, txt, md)

## Workflow

1. Read `@profile/personal_profile.md` (current state).
...
4. Write the **complete updated** `profile/personal_profile.md`. Never delete existing content without asking.
