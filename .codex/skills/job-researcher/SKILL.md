...
- Preserve the exact section names in the output format so downstream skills can rely on them, especially `## Company Intelligence` and `## Hiring Signals (objective)`.
